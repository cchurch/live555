...
// A demonstration application that uses our custom RTSP "DEREGISTER" command to deregister a stream
// with a RTSP client or proxy server main program
...
void usage() {
  *env << "usage: " << programName << " [-u <username> <password>] "
...
int main(int argc, char const** argv) {
  ...
  RTSPDeregisterSender::createNew(*env, remoteClientNameOrAddress, remoteClientPortNum, rtspURLToDeregister,
				deregisterResponseHandler, ourAuthenticator,
				proxyURLSuffix,
